		...
		function createNewSlider(element, options) {
			...
			**************************************************/
			...
			if (this.sliderElem) {
				...
				sliderTrack.className = "progress";

				sliderTrackSelection = document.createElement("div");
				sliderTrackSelection.className = "progress-bar";

				sliderMinHandle = document.createElement("div");
				sliderMinHandle.className = "progress-bar-handle min-slider-handle";

				sliderMaxHandle = document.createElement("div");
				sliderMaxHandle.className = "progress-bar-handle max-slider-handle";
