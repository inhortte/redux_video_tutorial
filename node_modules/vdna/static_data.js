...
module.exports = {
  ...
  showVdnaDivs: function() {
    ...
    $("*[vdnaroot]").each(function(index, vdnaRootEl) {
      ...
      // console.log("vdnaDivs (all) (sorting: " + that.sorting + "): " + JSON.stringify(that.vdnaDivs[vdnaRootName][that.sorting]));
  ...
  gatherVdna: function() {
    ...
    $("*[vdnaroot]").each(function(index, vdnaRootEl) {
      ...
      that.vdnaDivs[vdnaRootName][1] = that.vdnaDivs[vdnaRootName][2].sort(that._weightSort);
      that.vdnaDivs[vdnaRootName][3] = that.vdnaDivs[vdnaRootName][4].sort(that._weightSort);
    });
